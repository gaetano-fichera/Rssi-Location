...
public class BlindMain implements MessageListener {
  ...
  public void messageReceived(int to, Message message) {
    ...
    System.out.println("Msg ricevuto: " + msg.toString());

    //System.out.println("Msg ricevuto dal nodo " + source + " - X:" + msg.get_coordinate_x() + " - Y:" + msg.get_coordinate_y());
  }
  
  private static void usage() {
    System.err.println("usage: BlindMote [-comm <source>]");
  }
